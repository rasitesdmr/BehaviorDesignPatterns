    ...
    class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == saveBut) {
                ...
                caretaker.addMemento(originator.memenoMagazasi());
                ...
                if (currentArticle >= 1) {
                    ...
                    String textBoxString = originator.mementodanGeriYukle(caretaker.getMemento(currentArticle));
